...
export const getSteps = (): SetupStep[] => [
  {
    heading: 'Welcome to Rai',
    subheading: 'The steps below will guide you to quickly finish setting up your Rai installation.',
    title: 'Basic',
    info: 'The steps below will guide you to quickly finish setting up your Rai installation.',
    done: false,
    cards: [
      {
        type: 'tutorial',
        ...
        info: 'Set up and understand Rai if you have no prior experience. This tutorial guides you through the entire process and covers the “Data source” and “Dashboards” steps to the right.',
  ...
  },
  {
    ...
    subheading:
      'All necessary steps to use Rai are done. Now tackle advanced steps or make the best use of this home dashboard – it is, after all, a fully customizable dashboard – and remove this panel.',
    title: 'Advanced',
